...
const TASKS = [
  ...
  ["B18", 2, "【公開前ゲート】claimトークンがGA4に送信されるのを止める", "Claude", "B2", "/claim・/invite のURLを丸めてから送信。**発行前に必須**", 1, 2, "未着手"],
  ...
  ["D9", 4, "★claimオーナーが応募（ATS・応募DM）に到達できない", "オーナー判断→Claude", "B2", "applications/application_messages のRLSをメンバー起点へ", 2, 4, "未着手"],
  ["D10", 4, "/organizations/[id] の ISR 導入（流入時の負荷対策）", "オーナー判断→Claude", "—", "1アクセス毎のサーバ処理を減らす。claim_status の鮮度と要トレードオフ", 2, 3, "未着手"],
