...
const TASKS = [
  ...
  ["B18", 2, "【公開前ゲート】claimトークンがGA4に送信されるのを止める", "Claude", "B2", "/claim・/invite のURLを丸めてから送信。**発行前に必須**。コード対応済み（2026-08-12）。残：実プロパティでの再検証・GA4管理画面の拡張計測機能確認（オーナー・docs/owner-todo.md）", 1, 2, "🟡 コード完了・オーナー確認待ち"],
