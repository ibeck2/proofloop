...
| AH | **ダークモード導入**（全ページ手動トグル） | ✅ **実装完了・9タスク全完了**（2026-08-22、`feature/dark-mode`ブランチ・main未マージ）。Task 8検証で発見した不透明度修飾子（`text-paper/70`等559箇所）の回帰もTask 9で修正済み | 設計 `docs/superpowers/specs/2026-08-22-dark-mode-design.md`、実装計画 `docs/superpowers/plans/2026-08-22-dark-mode.md`。詳細は下記セクションAH |
