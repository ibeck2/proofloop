...
アカウントの有無を確認したい場合は、バリューコマースの管理画面（`https://www.valuecommerce.ne.jp/`）に心当たりのあるメールアドレスでログインを試すのが早いです。sid `3766669` が自分のものかは、ログイン後のサイト情報で照合できます。
